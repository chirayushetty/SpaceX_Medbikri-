   ...
   {!company ? <Loading /> :  <section className="showcase">
      <div className="overlay">
        ...
        <article className="text-white">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto mt-10 lg:gap-20 uppercase px-5">

          <article>
        <h2 className="font-bold border-b-2 border-white text-xl mb-3 pb-2 tracking-wider uppercase">About</h2>
          ...
          <article>
        <h2 className="font-bold border-b-2 border-white text-xl mb-3 pb-2 tracking-wider uppercase">Headquarters</h2>
          <ul className="text-sm opacity-75">
        ...
        <article>
        <h2 className="font-bold border-b-2 border-white text-xl mb-3 pb-2 tracking-wider uppercase">Useful Links</h2>
          <ul className="text-sm opacity-75">
            ...
            <li className="mb-1"><a href={company.links.elon_twitter}>Elon's Twitter</a></li>
          </ul>
        </article>
